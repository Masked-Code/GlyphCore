...
KNOWN_WARLOCK_SPELLS = {
    "armor_of_agathys": get_armor_of_agathys,
    "arms_of_hadar": get_arms_of_hadar,
    ...
    "eldritch_blast": get_eldritch_blast,
    ...
    "hellish_rebuke": get_hellish_rebuke,
    "hex": get_hex,
    "hold_monster": get_hold_monster,
    "hold_person": get_hold_person,
    "hunger_of_hadar": get_hunger_of_hadar,
