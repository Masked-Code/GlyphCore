...
KNOWN_CLERIC_SPELLS = {
    ...
    "beacon_of_hope": get_beacon_of_hope,
    "bestow_curse": get_bestow_curse,
    "blade_barrier": get_blade_barrier,
    "bless": get_bless,
    "blight": get_blight,
    ...
    "command": get_command,
    "commune": get_commune,
    "conjure_celestial": get_conjure_celestial,
    "contagion": get_contagion,
    "continual_flame": get_continual_flame,
    "control_weather": get_control_weather,
    "create_food_and_water": get_create_food_and_water,
    "create_undead": get_create_undead,
    "create_or_destroy_water": get_create_or_destroy_water,
    "cure_wounds": get_cure_wounds,
    "daylight": get_daylight,
    "death_ward": get_death_ward,
    "detect_evil_and_good": get_detect_evil_and_good,
    "detect_magic": get_detect_magic,
    "detect_poison_and_disease": get_detect_poison_and_disease,
    "dispel_evil_and_good": get_dispel_evil_and_good,
    "dispel_magic": get_dispel_magic,
    "divination": get_divination,
    "divine_word": get_divine_word,
    ...
    "flame_strike": get_flame_strike,
    "forbiddance": get_forbiddance,
    "freedom_of_movement": get_freedom_of_movement,
    "gate": get_gate,
    "geas": get_geas,
    "gentle_repose": get_gentle_repose,
    "glyph_of_warding": get_glyph_of_warding,
    "greater_restoration": get_greater_restoration,
    "guardian_of_faith": get_guardian_of_faith,
    "guidance": get_guidance,
    "hallow": get_hallow,
    "harm": get_harm,
    "heal": get_heal,
    "healing_word": get_healing_word,
    "heroes_feast": get_heroes_feast,
    "holy_aura": get_holy_aura,
    "inflict_wounds": get_inflict_wounds,
    ...
    "mass_heal": get_mass_heal,
    "mass_healing_word": get_mass_healing_word,
    "meld_into_stone": get_meld_into_stone,
    "mending": get_mending,
    "planar_ally": get_planar_ally,
    "planar_binding": get_planar_binding,
    "plane_shift": get_plane_shift,
    "prayer_of_healing": get_prayer_of_healing,
