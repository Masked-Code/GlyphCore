...
KNOWN_PALADIN_SPELLS = {
    "aid": get_aid,
    "aura_of_life": get_aura_of_life,
    "aura_of_purity": get_aura_of_purity,
    "aura_of_vitality": get_aura_of_vitality,
    "banishing_smite": get_banishing_smite,
    "banishment": get_banishment,
    "bless": get_bless,
    "blinding_smite": get_blinding_smite,
    "branding_smite": get_branding_smite,
    "circle_of_power": get_circle_of_power,
    "command": get_command,
    "commune": get_commune,
    "commune_with_nature": get_commune_with_nature,
    "compelled_duel": get_compelled_duel,
    "create_food_and_water": get_create_food_and_water,
    "crusaders_mantle": get_crusaders_mantle,
    "cure_wounds": get_cure_wounds,
    "daylight": get_daylight,
    "destructive_wave": get_destructive_wave,
    ...
    "divine_favor": get_divine_favor,
    "elemental_weapon": get_elemental_weapon,
    "find_steed": get_find_steed,
    "geas": get_geas,
    "heroism": get_heroism,
