...
KNOWN_DRUID_SPELLS = {
    ...
    "animal_shapes": get_animal_shapes,
    "antilife_shell": get_antilife_shell,
    "antipathy_sympathy": get_antipathy_sympathy,
    "awaken": get_awaken,
    "barkskin": get_barkskin,
    "beast_sense": get_beast_sense,
    "blight": get_blight,
    "call_lightning": get_call_lightning,
    ...
    "produce_flame": get_produce_flame,
    ...
    "storm_of_vengeance": get_storm_of_vengeance,
    "sunburst": get_sunburst,
    "thorn_whip": get_thorn_whip,
    "thunderwave": get_thunderwave,
    "transport_via_plants": get_transport_via_plants,
