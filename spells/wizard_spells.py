...
KNOWN_WIZARD_SPELLS = {
    ...
    "animate_dead": get_animate_dead,
    "animate_objects": get_animate_objects,
    "antimagic_field": get_antimagic_field,
    "antipathy_sympathy": get_antipathy_sympathy,
    "arcane_eye": get_arcane_eye,
    "arcane_lock": get_arcane_lock,
    "astral_projection": get_astral_projection,
    "banishment": get_banishment,
    "bestow_curse": get_bestow_curse,
    "bigbys_hand": get_bigbys_hand,
    ...
    "conjure_elemental": get_conjure_elemental,
    "conjure_minor_elementals": get_conjure_minor_elementals,
    "contact_other_plane": get_contact_other_plane,
    "contingency": get_contingency,
    "continual_flame": get_continual_flame,
    "control_water": get_control_water,
    "control_weather": get_control_weather,
    "counterspell": get_counterspell,
    "create_undead": get_create_undead,
    ...
    "mordenkainens_faithful_hound": get_mordenkainens_faithful_hound,
    "mordenkainens_magnificent_mansion": get_mordenkainens_magnificent_mansion,
    "mordenkainens_private_sanctum": get_mordenkainens_private_sanctum,
    "mordenkainens_sword": get_mordenkainens_sword,
    "move_earth": get_move_earth,
    "nondetection": get_nondetection,
    "nystuls_magic_aura": get_nystuls_magic_aura,
    "otilukes_freezing_sphere": get_otilukes_freezing_sphere,
    "otilukes_resilient_sphere": get_otilukes_resilient_sphere,
    "ottos_irresistible_dance": get_ottos_irresistible_dance,
    "passwall": get_passwall,
    "phantasmal_force": get_phantasmal_force,
    "phantasmal_killer": get_phantasmal_killer,
    "phantom_steed": get_phantom_steed,
    ...
    "prismatic_wall": get_prismatic_wall,
    ...
    "vampiric_touch": get_vampiric_touch,
    "wall_of_fire": get_wall_of_fire,
    "wall_of_force": get_wall_of_force,
    "wall_of_ice": get_wall_of_ice,
